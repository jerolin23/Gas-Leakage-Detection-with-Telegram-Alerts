...
void setup()
{
  ...
  pinMode(Sensor1Pin, INPUT);  // Set gasSensorPin as an input pin to read the analog output from the gas sensor
  pinMode(Sensor2Pin, INPUT);    // Set sensor2Pin as an input pin to read the analog output from the second sensor
